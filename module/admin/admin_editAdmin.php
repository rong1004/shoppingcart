		...
		<div class="backgEdit" id="backgEdit">
											<div class="adminforme" id="adminforme"> 
												<div class="adminformetitle">
													<button class="previous" onclick="window.location.assign('admin.php');"><h>&#8249;</h></button>
													<div class="title"><h>Admin details</h></div>
															...
															<div class="adminformeinput"> 
																<table>
																	...
																	<tr>
																		...
																		<td><select id="role" name="role" value="<?php echo $role; ?>">
																	...
																	<tr>
																		<th></th>
																		<td><input type="submit" onclick="submit()" value="Update">
																		<button  onclick="location.href='admin_deleteadmin.php?name=<?php echo $ID_admin?>'">DeleteUser</button></td>
																	</tr>
																</table>
